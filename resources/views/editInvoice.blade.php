...
<body>
    ...
    <div class="m-5">
        ...
        <form action="{{route('update', $invoice->id )}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="exampleInputNomor" class="form-label">Nomor Invoice</label>
                <input type="text" value="{{old('nomor_invoice')}}" class="form-control @error('nomor_invoice') is-invalid @enderror" id="exampleInputNomor" name="nomor_invoice">
            </div>
